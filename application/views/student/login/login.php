    ...
    <div id="wrapper">
        <div id="login_div">
         <h1>Student Login</h1>
            ...
            <?php echo form_open('log_stud_val', $attributes); ?>
            ...
            <ul>
                <li>
                    <a href="<?php echo site_url('stu_reg_form');?>"  id="register">Register Now!</a>
                </li>
                <li>
                    <a href="<?php echo site_url('stud_reset');?>" id="forgot">Forgot password?</a><br>
                </li>
                <li>
